...
def singleton(class_):
    ...
    def get_instance(*args, **kwargs):
        if class_ not in instances:
            ...
            LOGGER.warn("Tried to create multiple instances of singleton {}"
...
class AdafruitPwmManager:
    ...
    def __init__(self, left_forward_port, left_backward_port,
        ...
        self.ports['left-motor'] = {'forward': left_forward_port,
                                    'backward': left_backward_port}
        self.ports['right-motor'] = {'forward': right_forward_port,
